 ...
 * Create Time : 2014-12-08 16:37:40
...
namespace SourcePro.Csharp.Practices.FoundationLibrary.Commons.Configuration
{
    ...
    /// </para>
    /// <para>
    /// Type : <see cref="ConfigurationStorage"/>
    /// </para>
    /// <para>
    ...
    public class ConfigurationStorage
    {
        ...
        #region ConfigurationStorage Constructors

        /// <summary>
        /// 用于初始化一个<see cref="ConfigurationStorage" />对象实例。
        /// </summary>
        ...
        public virtual void Save(string sectionName, object section, params string[] dependencies)
        {
            cache.Add(new CacheItem(sectionName, section)
            {
        ...
        public virtual bool IsExists(string sectionName)
        {
